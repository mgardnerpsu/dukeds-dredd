...
var EventEmitter, HANDLER_HOST, HANDLER_MESSAGE_DELIMITER, HANDLER_PORT, HOOK_TIMEOUT, child_process, console, emitter, handler, handlerBuffer, handlerClient, handlerCommand, hooks, language, net, now, pathGlobs, ref, ref1, ref2, ref3, spawn, which;
...
language = hooks != null ? (ref = hooks.configuration) != null ? (ref1 = ref.options) != null ? ref1.language : void 0 : void 0 : void 0;
...
pathGlobs = [].concat(hooks != null ? (ref2 = hooks.configuration) != null ? (ref3 = ref2.options) != null ? ref3.hookfiles : void 0 : void 0 : void 0);
...
hooks.beforeAll(function(transactions, callback) {
  ...
  handlerClient.write(HANDLER_MESSAGE_DELIMITER);
  messageHandler = function(receivedMessage) {
    var i, index, len, ref4, value;
    clearTimeout(timeout);
    ref4 = receivedMessage.data;
    for (index = i = 0, len = ref4.length; i < len; index = ++i) {
      value = ref4[index];
