...
TransactionRunner = (function() {
    ...
    if ((hooks != null) && Array.isArray(hooks)) {
      ...
      runHookWithData = (function(_this) {
        return function(hookFnIndex, callback) {
          var base, base1, base2, base3, base4, error, hookFn, key, message, ref, value;
  ...
  TransactionRunner.prototype.executeTransaction = function(transaction, hooks, callback) {
    var base, base1, buffer, caseInsensitiveRequestHeadersMap, configuration, error, handleRequest, key, message, ref, ref1, ref2, req, requestOptions, test, transport, value;
    if (!callback) {
      callback = hooks;
      hooks = null;
    }
